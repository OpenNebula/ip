(function (global, factory) {
  ...
  var useTable = function useTable(props) {
    ...
    var _React$useState = React.useState(function () {
      return reducer(initialState, {
        ...
        reducerState = _React$useState[0],
        setReducerState = _React$useState[1];

    var dispatch = React.useCallback(function (action) {
      return setReducerState(function (prev) {
        return reducer(prev, action);
      });
    }, [reducer]); // Allow the user to control the final state with hooks
  ...
  var getTableProps$1 = function getTableProps(props, _ref) {
    ...
    var gridTemplateColumns = instance.visibleColumns.map(function (column) {
      ...
      if ((_instance$state$colum = instance.state.columnResizing) != null && _instance$state$colum.isResizingColumn) return instance.state.gridLayout.startWidths[column.id] + "px";
